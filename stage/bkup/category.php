...
$featured_posts = get_field('select_featured_post', 'category_' . $cat2_id);
$cat_thumbnail = get_field('thumbnail_image', 'category_' . $cat2_id);
                            ...
                            <div class="newsletter-news-top-lt">
                                <div class="newsletter-news-post pos-relative">
                                    <?php if ($desktop_img || $mobile_img) { ?>
                                        <div class="newsletter-news-thumb">
    ...
    <section class="news-filter">
        <div class="container">
            ...
            foreach ($posts_list as $post_id) {
                ...
                if ($post_cats) {
                    foreach ($post_cats as $cat) {
                        if ($cat->slug !== 'newsroom' && $cat->term_id != 1) {
            ...
            <div class="news-filter-inner flex">
                ...
                <ul>
                    <li class="active"><a href="/newsroom/">All News<em class="fa-sharp fa-thin fa-arrow-right" id="cat-filter"></em></a></li>
        ...
        <section class="news-lists-wrap">
            <div class="container">
                ...
                <span class="button">Read More</span>
                    ...
                    <ul data-path="<?php bloginfo('stylesheet_directory'); ?>" data-display-posts="9" data-post-type="post" data-searchblog="<?php echo $search; ?>" data-category="<?php echo $cat_idx; ?>" data-postsCount="<?php echo $postsCount; ?>" data-pageNumber="<?php echo $pagenumber; ?>" data-order="DESC" data-post-not-in="<?php echo esc_attr($exclude_post); ?>" data-button-text="Load more">
                </div>
            </div>
        </section>
    <?php endif; ?>
