    ...
    if (jqr5("#ajax-load-more").length) {
	 //e = 1,
       ...
       console.log(p);
        ...
        i.append('<div id="load-more-news" class="news-post-btn flex flex-center"><span class="loader"></span><span class="btn-center btn-primary" tabindex="0"><span class="button">' + jqr5button + "</span></span></div>");
        var u = function() {
