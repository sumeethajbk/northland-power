  ...
  <section class="default-banner-section white-banner pos-relative">
    ...
    <div class="container">
      <div class="default-banner-main flex">
        <div class="default-banner-text" data-js-animation="fade-in-up">
...
<section class="secwrap">
  ...
  if ($query_executive_team->have_posts()) { ?>
    <section class="leaders-management-section js-website-section">
      <div class="container">
          ...
          <div class="leaders-management-grids flex">
            <?php while ($query_executive_team->have_posts()) {
              ...
              if ($our_team_profile_image || get_the_title() || $our_team_position || $our_team_description || $our_team_linkedin_link || $our_team_email) { ?>
                <div class="card js-content-opacity">
...
if ($query_board_directors->have_posts()) { ?>
  <section class="bod-section js-website-section">
    <div class="container">
      <div class="leaders-management-wrap">
        <div class="heading sec-heading">
          <div class="heading-lt">
...
if ($query_senior_leadership->have_posts()) { ?>
  <section class="team-section" data-js-animation="fade-in-up">
    <div class="container">
...
if ($parent_term) {
  ...
  if (!empty($sub_terms)) { ?>
    <section class="groups-main" data-js-animation="fade-in-up">
      <div class="container">
...
?>
<section class="cta-module pos-relative cta-reverse" style="background:  <?php echo $leading_with_purpose_background_color; ?>" data-js-animation="fade-in">
        ...
        <div class="cta-main flex">
          ...
          <div class="graph-icon-wrap">
            ...
            <div class="graph-icon-main">
              <div class="graph-icon ui ui-timeline" data-animation>
